...
const Home = () => {
  ...
  const features = [
    { icon: <Users className="w-8 h-8 text-white" />, title: "Equipe Especializada", description: "Pesquisadores e especialistas dedicados ao desenvolvimento de soluções inovadoras com experiência multidisciplinar.", gradient: "from-blue-500 to-cyan-400" },
    { icon: <Lightbulb className="w-8 h-8 text-white" />, title: "Inovação Tecnológica", description: "Desenvolvimento de tecnologias emergentes e soluções disruptivas que transformam ideias em realidade.", gradient: "from-purple-500 to-pink-400" },
    { icon: <Target className="w-8 h-8 text-white" />, title: "Resultados Práticos", description: "Foco em pesquisas aplicadas que geram impacto real na sociedade, indústria e comunidade acadêmica.", gradient: "from-green-500 to-teal-400" }
  ];
            ...
            {features.map((feature, index) => (
              <div key={index} className="group relative">
                <div className="bg-white rounded-2xl p-8 shadow-lg hover:shadow-2xl transition-all duration-500 hover-lift border border-gray-100">
                  <div className={`w-16 h-16 bg-gradient-to-br ${feature.gradient} rounded-2xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform duration-300`}>{feature.icon}</div>
      ...
      <section className="py-20 bg-gradient-to-br from-gray-50 to-white relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-5xl font-bold text-gray-900 mb-6 tracking-tight">Conheça Nossos <span className="numbers-primary">Projetos</span></h2>
            <p className="text-xl text-gray-600 mb-12 leading-relaxed">Descubra as pesquisas e desenvolvimentos que estamos realizando para transformar ideias em soluções práticas que impactam o mundo real.</p>
